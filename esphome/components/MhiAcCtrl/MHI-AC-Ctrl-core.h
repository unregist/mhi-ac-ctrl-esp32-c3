...
#define GPIO_CS_IN                  GPIO_NUM_8 // GPIO_NUM_10 was used, however for my board 8 is easier
#define GPIO_IDK                    GPIO_NUM_3 // GPIO_NUM_3 was used a few times but not connected, I don't know if it does anything
